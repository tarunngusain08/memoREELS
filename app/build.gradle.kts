...
android {
    namespace = "com.example.memoreels"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.memoreels"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // ML Kit Image Labeling (bundled, fully offline)
    implementation("com.google.mlkit:image-labeling:17.0.8")

    // Coroutines integration for Google Play Services Task API
